...
const REGION_META: { region: Region; label: string; color: string }[] = [
  { region: 'north-america', label: 'North America', color: '#FF6B6B' },
  { region: 'central-america', label: 'Central America', color: '#4ECDC4' },
  { region: 'caribbean', label: 'Caribbean', color: '#FFD93D' },
  { region: 'south-america', label: 'South America', color: '#6C5CE7' },
];

export function Legend() {
  const items = useMemo(() => REGION_META, []);
